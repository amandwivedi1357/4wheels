...
export default function Test3() {
  ...
  return (
   ...
   <div className="main_test_cont">
            ...
            <p className="cust_text">A big thank you to Mr. S.M. Jain and the 4 Wheel Travels team for making our family function a grand success. Their exceptional service and round-the-clock assistance were greatly appreciated. Special thanks to Mr. Rambabu and Babu for their dedication.I wish you all the success in future.</p>
            ...
            <p style={{textAlign:'left',margin:'2rem 1rem 0rem 0rem',padding:'0',display:"flex"}}>
              ...
              <p className='cust_name'>Yogesh Agarwal (Agarwal Global Steels Limited)</p>
              </div>
